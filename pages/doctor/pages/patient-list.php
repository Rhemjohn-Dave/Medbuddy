...
// Fetch patients who have had at least one appointment with this doctor
$query = "SELECT p.*, CONCAT(p.first_name, ' ', p.last_name) as patient_name, MAX(a.date) as last_visit
          FROM patients p
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php foreach ($prescriptions as $pres): ?>
                                                <tr>
                                                    <td><?php echo htmlspecialchars($pres['created_at'] ?? $pres['record_date'] ?? '-'); ?></td>
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $patient['last_visit'] ? date('M d, Y', strtotime($patient['last_visit'])) : 'Never'; ?></td>
                                <td>
                                    <div class="btn-group">
