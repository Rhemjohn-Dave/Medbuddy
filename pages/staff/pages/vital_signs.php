...
// Get today's appointments that need vital signs or have them recorded
$sql = "SELECT a.*, 
        ...
        CASE WHEN vs.id IS NOT NULL THEN 1 ELSE 0 END as has_vitals -- Use this to determine if vitals are recorded
        FROM appointments a
