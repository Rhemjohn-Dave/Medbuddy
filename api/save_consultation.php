    ...
    try {
        ...
        if (!empty($prescription)) {
            ...
            foreach ($prescriptions as $index => $prescription_line) {
                ...
                // Parse prescription data - format: "medication_name|dosage|frequency|duration|instructions"
                ...
                if (count($prescription_parts) >= 5) {
                    ...
                    $duration = trim($prescription_parts[3]);
                    ...
                    $prescription_text = "$medication_name|$dosage|$frequency|$duration|$instructions";
                    ...
                    $sql_med = "INSERT INTO medications 
                               ...
                               VALUES 
                               (:patient_id, :medication_name, :dosage, :frequency, CURDATE(), 
                                DATE_ADD(CURDATE(), INTERVAL :duration DAY), :doctor_id, 'active', :instructions, NOW())";
                    ...
                    $stmt_med->bindParam(':duration', $duration);
